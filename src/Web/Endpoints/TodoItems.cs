using ProjectHub.Application.Common.Models;
using ProjectHub.Application.TodoItems.Commands.CreateTodoItem;
using ProjectHub.Application.TodoItems.Commands.DeleteTodoItem;
using ProjectHub.Application.TodoItems.Commands.UpdateTodoItem;
using ProjectHub.Application.TodoItems.Commands.UpdateTodoItemDetail;
using ProjectHub.Application.TodoItems.Queries.GetTodoItemsWithPagination;
using Microsoft.AspNetCore.Http.HttpResults;

namespace ProjectHub.Web.Endpoints;
